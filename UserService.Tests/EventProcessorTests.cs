...
public class EventProcessorTests
{
    ...
    [Fact]
    public void ProcessEvent_CallsAddUser_WhenRegisterEventReceived()
    {
        // Arrange
        _mockRepo.Setup(r => r.ProfileExist("a6427685-84e3-4fbf-8716-c94d1053b020")).Returns(false);
        _mockRepo.Setup(r => r.CreateProfile(It.IsAny<Profile>()))
            .Callback<Profile>(p =>
            {
        ...
        // Assert
        _mockRepo.Verify(r => r.CreateProfile(It.Is<Profile>(p =>
    ...
    [Fact]
    public void ProcessEvent_CallsDeleteUser_WhenDeleteAccountEventReceived()
    {
        // Arrange
        ...
        _mockRepo.Setup(r => r.ProfileExist("a6427685-84e3-4fbf-8716-c94d1053b020")).Returns(true);
        _mockRepo.Setup(r => r.GetProfileById("a6427685-84e3-4fbf-8716-c94d1053b020")).Returns(mockProfile);
        ...
        // Assert
        _mockRepo.Verify(r => r.GetProfileById("a6427685-84e3-4fbf-8716-c94d1053b020"), Times.Once);
